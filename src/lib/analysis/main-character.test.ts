...
describe('Main Character Analysis', () => {
	...
	it('should count mentions correctly', () => {
		const news: NewsItem[] = [
			{ id: '1', title: 'Trump announces policy', source: 'BBC', link: 'a', timestamp: Date.now(), category: 'politics' },
			{ id: '2', title: 'Trump speaks at rally', source: 'CNN', link: 'b', timestamp: Date.now(), category: 'politics' },
			{ id: '3', title: 'Biden meets with leaders', source: 'NYT', link: 'c', timestamp: Date.now(), category: 'politics' },
		];
	...
	it('should rank characters by mention count', () => {
		const news: NewsItem[] = [
			{ id: '1', title: 'Musk buys company', source: 'A', link: 'a', timestamp: Date.now(), category: 'tech' },
			{ id: '2', title: 'Elon announces feature', source: 'B', link: 'b', timestamp: Date.now(), category: 'tech' },
			{ id: '3', title: 'Musk tweets again', source: 'C', link: 'c', timestamp: Date.now(), category: 'tech' },
			{ id: '4', title: 'Trump rally today', source: 'D', link: 'd', timestamp: Date.now(), category: 'politics' },
		];
	...
	it('should limit results to top 10', () => {
		...
		const names = ['Trump', 'Biden', 'Musk', 'Putin', 'Zelensky', 'Xi', 'Netanyahu',
			'Sam Altman', 'Zuckerberg', 'Bezos', 'Tim Cook', 'Powell'];
	...
	it('should match multiple patterns for same person', () => {
		const news: NewsItem[] = [
			{ id: '1', title: 'Elon Musk announces', source: 'A', link: 'a', timestamp: Date.now(), category: 'tech' },
			{ id: '2', title: 'Musk speaks out', source: 'B', link: 'b', timestamp: Date.now(), category: 'tech' },
		];
	...
	it('should return correct summary', () => {
		...
		const news: NewsItem[] = [
			{ id: '1', title: 'Putin addresses nation', source: 'A', link: 'a', timestamp: Date.now(), category: 'politics' },
			{ id: '2', title: 'Putin speaks on economy', source: 'B', link: 'b', timestamp: Date.now(), category: 'politics' },
		];
	...
	it('should calculate dominance correctly', () => {
		...
		const singleNews: NewsItem[] = [
			{ id: '1', title: 'Trump news', source: 'A', link: 'a', timestamp: Date.now(), category: 'politics' },
		];
		...
		const evenNews: NewsItem[] = [
			{ id: '1', title: 'Trump speaks', source: 'A', link: 'a', timestamp: Date.now(), category: 'politics' },
			{ id: '2', title: 'Biden responds', source: 'B', link: 'b', timestamp: Date.now(), category: 'politics' },
		];
		...
		const dominantNews: NewsItem[] = [
			{ id: '1', title: 'Musk announcement', source: 'A', link: 'a', timestamp: Date.now(), category: 'tech' },
			{ id: '2', title: 'Elon tweets', source: 'B', link: 'b', timestamp: Date.now(), category: 'tech' },
			{ id: '3', title: 'Musk company news', source: 'C', link: 'c', timestamp: Date.now(), category: 'tech' },
			{ id: '4', title: 'Trump rally', source: 'D', link: 'd', timestamp: Date.now(), category: 'politics' },
		];
	...
	it('should handle case insensitivity', () => {
		const news: NewsItem[] = [
			{ id: '1', title: 'TRUMP announces policy', source: 'A', link: 'a', timestamp: Date.now(), category: 'politics' },
			{ id: '2', title: 'trump speaks today', source: 'B', link: 'b', timestamp: Date.now(), category: 'politics' },
		];
