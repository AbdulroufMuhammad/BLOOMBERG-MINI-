...
describe('Correlation Engine', () => {
	...
	it('should detect emerging patterns', () => {
		const news: NewsItem[] = [
			{ id: '1', title: 'Ukraine announces new policy', source: 'BBC', link: 'a', timestamp: Date.now(), category: 'politics' },
			{ id: '2', title: 'Ukraine military update', source: 'CNN', link: 'b', timestamp: Date.now(), category: 'politics' },
			{ id: '3', title: 'Zelensky addresses nation', source: 'NYT', link: 'c', timestamp: Date.now(), category: 'politics' },
		];
	...
	it('should track cross-source correlations', () => {
		const news: NewsItem[] = [
			{ id: '1', title: 'Tariff news today', source: 'BBC', link: 'a', timestamp: Date.now(), category: 'finance' },
			{ id: '2', title: 'Trade war escalates', source: 'CNN', link: 'b', timestamp: Date.now(), category: 'finance' },
			{ id: '3', title: 'Import tax increases', source: 'NYT', link: 'c', timestamp: Date.now(), category: 'finance' },
			{ id: '4', title: 'Customs duty update', source: 'WSJ', link: 'd', timestamp: Date.now(), category: 'finance' },
		];
	...
	it('should collect headlines for patterns', () => {
		const news: NewsItem[] = [
			{ id: '1', title: 'Gaza conflict escalates', source: 'BBC', link: 'https://bbc.com/1', timestamp: Date.now(), category: 'politics' },
			{ id: '2', title: 'Hamas negotiations', source: 'CNN', link: 'https://cnn.com/2', timestamp: Date.now(), category: 'politics' },
			{ id: '3', title: 'Israel Gaza update', source: 'NYT', link: 'https://nyt.com/3', timestamp: Date.now(), category: 'politics' },
		];
	...
	it('should return correct summary', () => {
		...
		const news: NewsItem[] = [
			{ id: '1', title: 'Ukraine update', source: 'BBC', link: 'a', timestamp: Date.now(), category: 'politics' },
			{ id: '2', title: 'Ukraine news', source: 'CNN', link: 'b', timestamp: Date.now(), category: 'politics' },
			{ id: '3', title: 'Zelensky speaks', source: 'NYT', link: 'c', timestamp: Date.now(), category: 'politics' },
		];
